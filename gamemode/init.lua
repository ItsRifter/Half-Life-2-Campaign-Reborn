...
util.AddNetworkString("HL2CR_ResetSkills")
...
util.AddNetworkString("HL2CR_SellSlot")
...
util.AddNetworkString("HL2CR_OpenPets")
util.AddNetworkString("HL2CR_OpenCustomMap")
util.AddNetworkString("HL2CR_VoteCustomMap")
...
util.AddNetworkString("HL2CR_MutatePet")
