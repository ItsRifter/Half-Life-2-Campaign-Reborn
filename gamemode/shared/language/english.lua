...
LANGUAGE.ACH_FAILED_PACIFIST			= " killed a stalker\nachievement failed"
--Skills
...
LANGUAGE.Submissive_Desc				= "Put the can\nin the trash"
LANGUAGE.Defiant_Desc					= "Hit the trashcan\ncop with the can"
...
LANGUAGE.Radiation_Levels_Desc			= "Get through the toxic tunnel\nunder City 17 in Half-Life 2"
LANGUAGE.Red_Letter_Baby_Desc			= "Take the baby from the\nplayground to Dr.Kleiner's lab"
LANGUAGE.Zero_Point_Energy_Desc			= "Acquire the Gravity Gun\nin Black Mesa East"
LANGUAGE.Two_Points_Desc_Desc			= "Use DOG's ball\nto make a basket"
