--Ammo Limits Convars
CreateConVar("hl2cr_base_pistol", 			    150, 	{FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_ARCHIVE} )
CreateConVar("hl2cr_base_357", 				    12, 	{FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_ARCHIVE} )
CreateConVar("hl2cr_base_smg1", 				225, 	{FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_ARCHIVE} )
CreateConVar("hl2cr_base_smg1_grenade", 		3, 		{FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_ARCHIVE} )
CreateConVar("hl2cr_base_ar2", 				    60, 	{FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_ARCHIVE} )
CreateConVar("hl2cr_base_ar2_ball", 			3, 		{FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_ARCHIVE} )
CreateConVar("hl2cr_base_buckshot", 			30, 	{FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_ARCHIVE} )
CreateConVar("hl2cr_base_crossbowbolt", 		10, 	{FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_ARCHIVE} )
CreateConVar("hl2cr_base_slam", 				5, 		{FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_ARCHIVE} )
CreateConVar("hl2cr_base_rpg_round", 		    3, 		{FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_ARCHIVE} )
CreateConVar("hl2cr_base_frags", 			    5, 		{FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_ARCHIVE} )
