...
function PANEL:Init()
	...
	--local Text = vgui.Create( "ThemeTextMulti" , self)
	--Text:SetSize( 0, 0)
	...
	local Check = New_ThemeCheck(OpPanel,OpPanel:GetWide() * 0.35, OpPanel:GetTall() * 0.1,OpPanel:GetWide() * 0.3, OpPanel:GetTall() * 0.08,translate.Get("Options_Cross"),"Font_Small")
	--local Check = vgui.Create( "ThemeCheckBox" , OpPanel)
	--Check:SetSize( OpPanel:GetWide() * 0.3, OpPanel:GetTall() * 0.08)
	--Check:SetPos( OpPanel:GetWide() * 0.35, OpPanel:GetTall() * 0.1)
	...
	local Check = New_ThemeCheck(OpPanel,OpPanel:GetWide() * 0.35, OpPanel:GetTall() * 0.2,OpPanel:GetWide() * 0.3, OpPanel:GetTall() * 0.08,translate.Get("Options_HideXp"),"Font_Small")
	--local Check = vgui.Create( "ThemeCheckBox" , OpPanel)
	--Check:SetSize( OpPanel:GetWide() * 0.3, OpPanel:GetTall() * 0.08)
	--Check:SetPos( OpPanel:GetWide() * 0.35, OpPanel:GetTall() * 0.2)
	...
	MultiBox:SetPos( OpPanel:GetWide() * 0.35, OpPanel:GetTall() * 0.5)
