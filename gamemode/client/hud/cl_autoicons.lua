...
killicon.GetSize = function(name)
    if BASED_KILLICON_EXISTS(name) then return BASED_KILLICON_GETSIZE(name) end
...
killicon.Draw = function(x, y, name, alpha)
    if BASED_KILLICON_EXISTS(name) then return BASED_KILLICON_DRAW(x, y, name, alpha) end
